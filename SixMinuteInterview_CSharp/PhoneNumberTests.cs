...
namespace SixMinuteInterview_CSharp
{
    ...
    public class PhoneNumberTests
    {
        ...
        public void Test1()
        {
            var ph = new PhoneNumber("+1(858)775-2868");
        ...
        public void Test2()
        {
            var ph = new PhoneNumber("+1(858)775-2868x123");
        ...
        public void Test3()
        {
            var ph = new PhoneNumber("+598.123.4567x858");
        ...
        public void Test4()
        {
            var ph = new PhoneNumber("+27 1234 5678 ext 4");
        ...
        public void Test5()
        {
            var ph = new PhoneNumber("858-775-2868");
