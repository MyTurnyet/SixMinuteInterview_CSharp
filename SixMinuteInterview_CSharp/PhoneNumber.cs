...
namespace SixMinuteInterview_CSharp
{
    public class PhoneNumber
    {
        ...
        private static readonly List<string> Reasons = new List<string>
            {"Phone Number Too Long or Too Short", "US Number must be length 10", "Unknown Country Code"};

        // An index into the COUNTRY_CODES array
        private readonly int _countryCodeIndex = 0;
        private readonly string _invalidReason = null;

        /** The original value. */
        private readonly string _originalValue = null;
